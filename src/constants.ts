...
export const YEARS_ELM_QUERY = DIV_NAMESPACE + "-years";
export const YEAR_ELM_QUERY = DIV_NAMESPACE + "-year";
export const MONTHS_ELM_QUERY = DIV_NAMESPACE + "-months";
export const MONTH_ELM_QUERY = DIV_NAMESPACE + "-month";
export const DAYS_ELM_QUERY = DIV_NAMESPACE + "-days";
export const DAYS_HEADER_ELM_QUERY = DIV_NAMESPACE + "-days-header";
export const DAY_ELM_QUERY = DIV_NAMESPACE + "-day";
export const DAY_NOTINMONTH_ELM_QUERY = DIV_NAMESPACE + "-day.not-in-month";
export const DAY_DISABLED_ELM_QUERY = DIV_NAMESPACE + "-day.disabled-day";
export const DAY_DISABLED_NOTINMONTH_ELM_QUERY = DAY_NOTINMONTH_ELM_QUERY + ".disabled-day";
export const DAY_NAME_ELM_QUERY = DIV_NAMESPACE + "-day-name";
export const PLUS_ICON_ELM_QUERY = DIV_NAMESPACE + "-icon-plus";
export const MINUS_ICON_ELM_QUERY = DIV_NAMESPACE + "-icon-minus";
export const FOOTER_ELM_QUERY = DIV_NAMESPACE + "-footer";
export const TODAY_BTN_ELM_QUERY = DIV_NAMESPACE + "-btn-today";
export const EMPTY_BTN_ELM_QUERY = DIV_NAMESPACE + "-btn-empty";
export const CLOSE_BTN_ELM_QUERY = DIV_NAMESPACE + "-btn-close";
export const FOOTER_TIME_ELM_QUERY = DIV_NAMESPACE + "-time-container";
export const TIME_DROPDOWN_PARENT_ELM_QUERY = DIV_NAMESPACE + "-time";
